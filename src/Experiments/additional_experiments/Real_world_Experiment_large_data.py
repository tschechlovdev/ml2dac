...
real_world_path = "real_world_data/not_processed/"
...
for f in files:
    ...
    for cvi in [CVIHandler.CVICollection.DENSITY_BASED_VALIDATION, CVIHandler.CVICollection.COP_SCORE]:
        ML2DAC = ApplicationPhase(mkr_path=mkr_path, mf_set=mf_set)
