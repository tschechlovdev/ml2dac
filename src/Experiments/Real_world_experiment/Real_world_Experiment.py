...
real_world_path = "/home/tschecds/automlclustering/src/Experiments/real_world_data/"
path_to_store_results = Path("/home/tschecds/automlclustering/src/Experiments/real_world_results/ML2DAC/")
    ...
    for n_similar_datasets in similar_datasets:
        for run in runs:
            for f in files:
                ...
                #if X.shape[0] != 20000:
                #    continue
                if X.shape[0] <= 100000000000000000:
