...
def gen_figures(evaluation=False, real_world=False, ablation=False):
    ...
    stats_general_df = pd.read_csv(f'{base_path}evaluation_results/synthetic_data/results_statistical+general.csv', index_col=None)
    ...
    stats_info_general_df = pd.read_csv(f'{base_path}evaluation_results/synthetic_data/results_statistical+info-theory+general.csv', index_col=None)
